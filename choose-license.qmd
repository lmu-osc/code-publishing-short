...
Some journals offer to publish your article under a free/open license,
...
through the respective free/open license [@Rumsey2022]
...
[one for software, writing, images, audio, and video](/in_depth_material/licenses-continued.qmd#fig-flowchart-non-data)
and [one for data](/in_depth_material/licenses-continued.qmd#fig-flowchart-data) where you can make additional choices.
...
All conditions are explained on the supplementary page on [copyright conditions](in_depth_material/copyright-conditions.qmd).

From the Creative Commons licenses,
only [CC0\ 1.0][cc0] does not require providing attribution,
and all software licenses in [the first advanced license flowchart](/in_depth_material/licenses-continued.qmd#fig-flowchart-non-data) require providing attribution.
...
- A summary of the licensing situation is often given in a README file,
  whose creation will be discussed [later](make-readme.qmd).
...
Therefore, you could apply any license to your modified version.

Please practice this now by dual-licensing the manuscript and the bibliography
under the licenses [CC0\ 1.0][cc0] and [Apache\ 2.0][apache2]
(as recommended in @nte-license-choice-tldr) by updating the file `LICENSE.txt`.
...
The Quarto documents stored in "Manuscript.qmd", "Manuscript.tex", and "Manuscript.pdf" by Josephine Zerna, Christoph Scheffel, and <YOUR NAME> are available under CC0\ 1.0 <https://creativecommons.org/publicdomain/zero/1.0/> or (at your option) under Apache License\ 2.0 <https://choosealicense.com/licenses/apache-2.0/>.

The bibliography (stored in "Bibliography.bib") by Florian Kohrt and <YOUR NAME> is available under CC0\ 1.0 or (at your option) under Apache License\ 2.0.
```
:::
