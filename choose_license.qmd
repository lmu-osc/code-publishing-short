...
- __fonts:__ Copyleft licenses applied to fonts can be a special case: If a font is put under the license [CC\ BY-SA\ 4.0](https://creativecommons.org/licenses/by-sa/4.0/), any documents containing texts using that font will probably be derivative works and have to be put under the same license if shared. As a non-copyleft license, [CC0\ 1.0](https://creativecommons.org/publicdomain/zero/1.0/) is a good choice for fonts.
