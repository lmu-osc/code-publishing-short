...
In the (rare) case that the software you developed has a technical application,
that it falls under the legal definition of an invention,
you are required to officially report your invention to the university which decides on its release.
However, the [IP strategy](https://www.serviceportal.verwaltung.uni-muenchen.de/services/forschungsservices/_downloads/07_ip_strategy.pdf) of the LMU highlights that
"LMU can make the greatest contribution to the value chain by focusing on the production of outstanding results in basic research and by helping to **make the results publicly accessible**.
It follows that the commercial exploitation of research results has an accessory role".
Furthermore, "as a rule, the inventor is entitled to the discretionary use of invention- and research-based results".
Taken together, LMU emphasizes the importance of openness of research results and the freedom of researchers to share their findings widely.

Only if the university claims the invention after you reported it, you may not apply a copyright license that contains a patent grant. In all other cases you are free to license your research project as you like.

More information about the invention disclosure process can be found in the [service portal](https://www.serviceportal.verwaltung.uni-muenchen.de/internationals/research_transfer/intellectual_property/index.html).
More information about software patents are provided by the FSFE: [Software Patents in Europe](https://fsfe.org/activities/swpat/swpat.en.html).
:::
