---
title: "Generation of Data Dictionaries Using R"
date: "today"
engine: knitr
---

_Note: This is an add-on to the Chapter "[Add Data and Data Dictionary](/data.qmd)". It describes how to (a) generate data dictionaries with R, and (b) how to create a machine readable documentation of the data._
...
stopifnot(file.exists("data.csv"))
```
...
Alternatives would be [RO-Crate](https://www.researchobject.org/ro-crate/)
