...
write.csv(
  dat,
  file = "in_depth_material/data.csv",
  row.names = FALSE
)
rm(idx, dat)
```
...
_For the purpose of this exercise, we keep it easy and propose that you 
manually create a file with the data dictionary
(e.g., as a table in .xlsx, .docx, .ods, or as a Markdown table), 
documenting only the bare minimum._
...
| name              | label          | type    | description                          | item_text                              | values                                | units | missing_codes |
| ----------------- | -------------- | ------- | ------------------------------------ | -------------------------------------- | ------------------------------------- | ----- | ------------- |
| species           | Species        | string  | Penguin species                      |                                        | 1 = Adelie; 2 = Chinstrap; 3 = Gentoo |       | -99 = Missing |
| island            | Island         | string  | Island where individual was observed |                                        | 1 = Biscoe; 2 = Dream; 3 = Torgersen  |       | -99 = Missing |
| bill_length_mm    | Bill length    | float   | Length of the bill (beak)            |                                        |                                       | mm    | -99 = Missing |
| bill_depth_mm     | Bill depth     | float   | Depth of the bill (beak)             |                                        |                                       | mm    | -99 = Missing |
| flipper_length_mm | Flipper length | integer | Length of the flipper                |                                        |                                       | mm    | -99 = Missing |
| body_mass_g       | Body mass      | integer | Body mass                            |                                        |                                       | g     | -99 = Missing |
| sex               | Sex            | string  | Sex of the penguin                   |                                        | 1 = female; 2 = male                  |       | -99 = Missing |
| year              | Year           | integer | Year of data collection              |                                        | 2007; 2008; 2009                      |       |               |
| cuteness          | Cuteness       | integer | Subjective cuteness                  | How cute do you think this penguin is? | 2007; 2008; 2009                      |       |               |
