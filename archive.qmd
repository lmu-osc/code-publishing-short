...
[excerpt from @Jackson2018, with footnotes removed, licensed under [CC\ BY\ 4.0][cc-by]]:
...
- __Fill in metadata__
  ...
  - __Licenses__:
    ...
    you can run enter `SPDX Document` as title
...
[Software Deposit Guidance for Researchers](https://softwaresaved.github.io/software-deposit-guidance/).
