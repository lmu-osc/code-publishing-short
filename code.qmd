...
::: {#tip-data-analysis-example .callout-tip collapse="true"}
...
This means that with regards to copyright
it can be used and distributed even without attribution.
:::
...
We will cover system dependencies when [creating a README](make-readme.qmd).
