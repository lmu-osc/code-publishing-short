...
- __Use project-relative paths.__ When you refer to a file within your project, write paths relative to your project root. For example, don't write `C:\Users\Public\Documents\my_project\images\result.png`, instead write `images\result.png`.^[In R, use `file.path()` for a platform-independent way to concatenate folders to build a path.]
